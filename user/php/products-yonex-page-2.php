...
<body>
    ...
    <div class="pagination">
        <a href="/user/php/products-yonex-page-1.php" class="page-link">&laquo; Trang trước</a>
        ...
        <a href="/user/php/products-yonex-page-3.php" class="page-link">Trang sau &raquo;</a>
    </div>
