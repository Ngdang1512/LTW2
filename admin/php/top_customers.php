...
<div class="content mt-5">
                        ...
                        <tbody>
                            ...
                            while ($order = $orders->fetch_assoc()): ?>
                                <tr>
                                    ...
                                    <td><a href="/admin/php/view_order.php?id=<?php echo $order['id']; ?>" class="btn btn-primary btn-sm">Xem chi tiết</a></td>
                                </tr>
                            <?php endwhile; ?>
                        </tbody>
                    </table>
    ...
    <?php endif; ?>
    <a href="/admin/php/order_list.php" class="btn btn-secondary">Quay lại</a>
</div>
</body>
</html>