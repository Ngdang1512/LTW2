<!-- filepath: d:\xampp\htdocs\LTW2\adminNGDANG\php\order_list.php -->
<?php
...
<div class="content">
    ...
    <form method="GET" action="top_customers.php" class="mb-4">
        <div class="row">
            <div class="col-md-4">
                <label for="from_date" class="form-label">Từ ngày</label>
        ...
        <tbody>
            ...
            while ($row = $result->fetch_assoc()) {
                echo "<tr>
                        ...
                        <td>
                            <a href='view_order.php?id={$row['id']}' class='btn btn-sm'>Xem</a>
                            <a href='delete_order.php?id={$row['id']}' class='btn btn-sm btn-danger' onclick='return confirm(\"Bạn có chắc chắn muốn xóa đơn hàng này?\")'>Xóa</a>
                        </td>
                      </tr>";
            }
            ?>
